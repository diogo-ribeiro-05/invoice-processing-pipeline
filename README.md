...
```
[Z.AI Primary] Calling model: glm-5
[Z.AI Primary] Response received in 2400ms, length: 1011
[JSON Parser] Successfully parsed response
PASS 1 complete. Vendor: Coolblue B.V. Tax ID: NL810433941B01
POST-PROCESSING: Validating vendor name against ERP...
Final Vendor: Coolblue B.V. Tax ID: NL810433941B01
```

## Sample Invoices

The `/invoices` directory contains 11 sample invoices for testing:

| File | Vendor | Currency |
|------|--------|----------|
| coolblue1.pdf, coolblue2.pdf | Coolblue B.V. | EUR |
| free_fiber.pdf | Free Fiber | EUR |
| saeco.pdf | Saeco | EUR |
| oyo.pdf | OYO | INR |
| FlipkartInvoice.pdf | Flipkart | INR |
| AmazonWebServices.pdf | AWS | USD |
| AzureInterior.pdf | Azure | USD |
| NetpresseInvoice.pdf | Netpresse | EUR |
| QualityHosting.pdf | Quality Hosting | USD |
| SammyMaystoneLinesTest.pdf | Sammy Maystone | EUR |
